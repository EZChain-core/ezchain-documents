...
<!-- If you use the [EZChain Bridge](https://bridge.ezchain.com) to transfer assets to EZChain, you will need some EZC to move/swap your assets. The EZChain Bridge provides an [airdrop](https://support.ezchain.com/en/articles/5462264-is-there-an-airdrop) of EZC to users who transfer more than a certain value of assets to EZChain. Use this EZC to swap some of your bridged assets for EZC so that you can pay future transaction fees. -->
...
<!-- . You can follow [this](https://support.ezchain.com/en/articles/5315160-creating-a-new-wallet-with-the-ezchain-wallet) guide to set up a new own wallet. -->

<!-- You can and should use a [hardware Ledger](https://support.ezchain.com/en/articles/6150237-how-to-use-a-ledger-nano-s-or-nano-x-with-ezchain) to log into your wallet. **Using a hardware wallet is the most secure way of accessing your tokens** because your private keys and the passphrase never leave the device. If you have an amount of tokens you would not be comfortable losing, it is strongly advised to invest in a hardware wallet. -->

<!-- Once you have your wallet, you may want to send your EZC from an exchange to your wallet. See [here](https://support.ezchain.com/en/articles/5315157-how-to-send-ezc-from-an-exchange-to-the-ezchain-wallet) for a guide on doing so. -->
...
Most of the activity on the EZChain network happens on various dapps (decentralized apps). To interact with them, you can use a browser extension that will connect your wallet with the dapp. [Metamask](http://metamask.io/) is one such popular wallet extension.
...
<!-- List of exchanges can be found [here](https://ecosystem.ezchain.com/marketplace?tag=exchange). -->
...
Once you have your browser extension (Metamask for example) set up, you are ready to interact with dapps on EZChain. Most of what you will want to do, such as _yield farming_, requires that you have tokens other than EZC. If you have those tokens on Ethereum (or an exchange that can send them to Ethereum), one of the cheapest and fastest ways of bringing them over is the [EZChain Bridge](https://bridge.ezchain.com/).

You can find a collection of video tutorials on the basic usage of the EZChain Bridge [here](https://www.youtube.com/playlist?list=PLRHl-ulWK4-FPRA7SS1OrCOC8cOc2K8sP). Also, make sure that you go over the [FAQ](https://docs.ezchain.com/learn/ezchain-bridge-faq) which answers most common questions about the bridge and highlights things to watch out for.

When you bridge over $75 or more of assets, you will also be airdropped some EZC to help pay for initial swaps. Use those funds only to acquire additional EZC as you will need EZC to pay for fees on every other dapp you use! If you get stranded without enough EZC for fees you will be unable to do anything else, so make sure you always have some EZC in your wallet. You can swap for EZC on [Pangolin](https://app.pangolin.exchange). -->
...
These are the official explorers for chains within EZChain subnets, maintained by EZC Labs

[DeFi Kingdoms' official explorer](https://subnets.ezchain.com/defi-kingdoms/dfk-chain/explorer) for the DFK Chain on the custom DeFi Kingdoms subnet.

[WAGMI Testnet Explorer](https://subnets.ezchain.com/wagmi/wagmi-chain-testnet/explorer) for the demo and testbed chain in the WAGMI subnet.
...
[EZCscan](https://ezc.can.info/) is an independent explorer website, known for its slick presentation and comprehensive overview, especially interesting for viewing [validators and delegators](https://ezc.can.info/staking/validators), as it shows lots of interesting information about individual network validators.

### VScout

[VScout](https://vscout.io/) is another alternative explorer for EZChain. Among other things there you can see distribution of validators across the planet. -->
