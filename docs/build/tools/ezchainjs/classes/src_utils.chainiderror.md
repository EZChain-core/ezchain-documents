[ezchain](../README.md) › [src/utils](../modules/src_utils.md) › [ChainIdError](src_utils.chainiderror.md)
...
*Defined in [src/utils/errors.ts:74](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/utils/errors.ts#L74)*
