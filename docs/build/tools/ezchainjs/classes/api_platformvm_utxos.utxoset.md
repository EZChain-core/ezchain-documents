[ezchain](../README.md) › [API-PlatformVM-UTXOs](../modules/api_platformvm_utxos.md) › [UTXOSet](api_platformvm_utxos.utxoset.md)
...
*Defined in [src/apis/platformvm/utxos.ts:142](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L142)*
...
*Defined in [src/apis/platformvm/utxos.ts:141](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L141)*
...
*Defined in [src/common/utxos.ts:264](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/common/utxos.ts#L264)*
...
*Defined in [src/apis/platformvm/utxos.ts:218](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L218)*
...
▸ **buildAddDelegatorTx**(`networkID`: number, `blockchainID`: Buffer, `ezcAssetID`: Buffer, `toAddresses`: Buffer[], `fromAddresses`: Buffer[], `changeAddresses`: Buffer[], `nodeID`: Buffer, `startTime`: BN, `endTime`: BN, `stakeAmount`: BN, `rewardLocktime`: BN, `rewardThreshold`: number, `rewardAddresses`: Buffer[], `fee`: BN, `feeAssetID`: Buffer, `memo`: Buffer, `asOf`: BN): *[UnsignedTx](api_platformvm_transactions.unsignedtx.md)*

*Defined in [src/apis/platformvm/utxos.ts:972](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L972)*
...
`ezcAssetID` | Buffer | - | [Buffer](https://github.com/feross/buffer) of the asset ID for EZC |
...
`stakeAmount` | BN | - | A [BN](https://github.com/indutny/bn.js/) for the amount of stake to be delegated in wei. |
...
▸ **buildAddValidatorTx**(`networkID`: number, `blockchainID`: Buffer, `ezcAssetID`: Buffer, `toAddresses`: Buffer[], `fromAddresses`: Buffer[], `changeAddresses`: Buffer[], `nodeID`: Buffer, `startTime`: BN, `endTime`: BN, `stakeAmount`: BN, `rewardLocktime`: BN, `rewardThreshold`: number, `rewardAddresses`: Buffer[], `delegationFee`: number, `fee`: BN, `feeAssetID`: Buffer, `memo`: Buffer, `asOf`: BN): *[UnsignedTx](api_platformvm_transactions.unsignedtx.md)*

*Defined in [src/apis/platformvm/utxos.ts:1079](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L1079)*
...
*Defined in [src/apis/platformvm/utxos.ts:566](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L566)*
...
*Defined in [src/apis/platformvm/utxos.ts:1254](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L1254)*
...
*Defined in [src/apis/platformvm/utxos.ts:1185](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L1185)*
...
▸ **buildExportTx**(`networkID`: number, `blockchainID`: Buffer, `amount`: BN, `ezcAssetID`: Buffer, `toAddresses`: Buffer[], `fromAddresses`: Buffer[], `changeAddresses`: Buffer[], `destinationChain`: Buffer, `fee`: BN, `feeAssetID`: Buffer, `memo`: Buffer, `asOf`: BN, `locktime`: BN, `threshold`: number): *[UnsignedTx](api_platformvm_transactions.unsignedtx.md)*

*Defined in [src/apis/platformvm/utxos.ts:799](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L799)*
...
`ezcAssetID` | Buffer | - | [Buffer](https://github.com/feross/buffer) of the asset ID for EZC |
`toAddresses` | Buffer[] | - | An array of addresses as [Buffer](https://github.com/feross/buffer) who recieves the EZC |
`fromAddresses` | Buffer[] | - | An array of addresses as [Buffer](https://github.com/feross/buffer) who owns the EZC |
`changeAddresses` | Buffer[] | undefined | An array of addresses as [Buffer](https://github.com/feross/buffer) who gets the change leftover of the EZC |
...
*Defined in [src/apis/platformvm/utxos.ts:655](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L655)*
...
*Defined in [src/apis/platformvm/utxos.ts:211](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L211)*
...
*Defined in [src/apis/platformvm/utxos.ts:207](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L207)*
...
*Defined in [src/apis/platformvm/utxos.ts:146](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L146)*
...
*Defined in [src/apis/platformvm/utxos.ts:227](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L227)*
...
▸ **getMinimumSpendable**(`aad`: [AssetAmountDestination](api_platformvm_utxos.assetamountdestination.md), `asOf`: BN, `locktime`: BN, `threshold`: number, `stakeable`: boolean): *[Error](src_utils.ezchainerror.md#static-error)*

*Defined in [src/apis/platformvm/utxos.ts:253](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L253)*
...
**Returns:** *[Error](src_utils.ezchainerror.md#static-error)*
...
*Defined in [src/apis/platformvm/utxos.ts:191](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/platformvm/utxos.ts#L191)*
