[ezchain](../README.md) › [Common-RESTAPI](../modules/common_restapi.md) › [RESTAPI](common_restapi.restapi.md)
...
\+ **new RESTAPI**(`core`: [EZChainCore](ezchaincore.ezchaincore-1.md), `baseURL`: string, `contentType`: string, `acceptType`: string): *[RESTAPI](common_restapi.restapi.md)*
...
------ | ------ | ------ | ------ |
`core` | [EZChainCore](ezchaincore.ezchaincore-1.md) | - | Reference to the EZChain instance using this endpoint |
...
*Defined in [src/common/restapi.ts:33](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/common/restapi.ts#L33)*
