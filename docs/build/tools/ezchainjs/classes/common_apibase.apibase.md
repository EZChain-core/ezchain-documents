[ezchain](../README.md) › [Common-APIBase](../modules/common_apibase.md) › [APIBase](common_apibase.apibase.md)
...
\+ **new APIBase**(`core`: [EZChainCore](ezchaincore.ezchaincore-1.md), `baseURL`: string): *[APIBase](common_apibase.apibase.md)*
...
------ | ------ | ------ |
`core` | [EZChainCore](ezchaincore.ezchaincore-1.md) | Reference to the EZChain instance using this baseURL |
