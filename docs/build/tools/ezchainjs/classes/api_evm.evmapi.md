[ezchain](../README.md) › [API-EVM](../modules/api_evm.md) › [EVMAPI](api_evm.evmapi.md)
...
* [EZCAssetID](api_evm.evmapi.md#protected-ezcassetid)
...
* [exportEZC](api_evm.evmapi.md#exportezc)
* [exportKey](api_evm.evmapi.md#exportkey)
* [getEZCAssetID](api_evm.evmapi.md#getezcassetid)
...
* [importEZC](api_evm.evmapi.md#importezc)
...
* [setEZCAssetID](api_evm.evmapi.md#setezcassetid)
...
\+ **new EVMAPI**(`core`: [EZChainCore](ezchaincore.ezchaincore-1.md), `baseURL`: string, `blockchainID`: string): *[EVMAPI](api_evm.evmapi.md)*

*Overrides [JRPCAPI](common_jrpcapi.jrpcapi.md).[constructor](common_jrpcapi.jrpcapi.md#constructor)*

*Defined in [src/apis/evm/api.ts:848](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L848)*
...
`baseURL` | string | "/ext/bc/C/ezc" | Defaults to the string "/ext/bc/C/ezc" as the path to blockchain's baseURL |
...
*Defined in [src/apis/evm/api.ts:66](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L66)*
...
*Defined in [src/apis/evm/api.ts:65](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L65)*
...
*Defined in [src/apis/evm/api.ts:64](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L64)*
...
*Defined in [src/apis/evm/api.ts:67](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L67)*
...
*Defined in [src/apis/evm/api.ts:152](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L152)*
...
*Defined in [src/apis/evm/api.ts:687](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L687)*
...
*Defined in [src/apis/evm/api.ts:612](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L612)*
...
*Defined in [src/apis/evm/api.ts:335](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L335)*

Send ANT (EZChain Native Token) assets including EZC from the C-Chain to an account on the X-Chain.
...
`to` | string | The account on the X-Chain to send the EZC to. |
...
▸ **exportEZC**(`username`: string, `password`: string, `to`: string, `amount`: BN): *Promise‹string›*

*Defined in [src/apis/evm/api.ts:370](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L370)*

Send EZC from the C-Chain to an account on the X-Chain.

After calling this method, you must call the X-Chain’s importEZC method to complete the transfer.
...
*Defined in [src/apis/evm/api.ts:580](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L580)*
...
*Defined in [src/apis/evm/api.ts:210](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L210)*
...
*Defined in [src/apis/evm/api.ts:253](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L253)*
...
*Defined in [src/apis/evm/api.ts:172](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L172)*
...
*Defined in [src/apis/evm/api.ts:298](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L298)*
...
*Defined in [src/apis/evm/api.ts:277](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L277)*
...
*Defined in [src/apis/evm/api.ts:880](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L880)*
...
*Defined in [src/apis/evm/api.ts:74](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L74)*
...
*Defined in [src/apis/evm/api.ts:109](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L109)*
...
*Defined in [src/apis/evm/api.ts:237](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L237)*
...
*Defined in [src/apis/evm/api.ts:897](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L897)*
...
*Defined in [src/apis/evm/api.ts:315](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L315)*
...
*Defined in [src/apis/evm/api.ts:402](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L402)*
...
*Defined in [src/apis/evm/api.ts:452](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L452)*

Send ANT (EZChain Native Token) assets including EZC from an account on the X-Chain to an address on the C-Chain. This transaction
...
▸ **importEZC**(`username`: string, `password`: string, `to`: string, `sourceChain`: string): *Promise‹string›*

*Defined in [src/apis/evm/api.ts:487](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L487)*

Send EZC from an account on the X-Chain to an address on the C-Chain. This transaction
...
`username` | string | The Keystore user that controls the account specified in `to` |
`password` | string | The password of the Keystore user |
`to` | string | The address of the account the EZC is sent to. This must be the same as the to argument in the corresponding call to the X-Chain’s exportEZC |
...
*Defined in [src/apis/evm/api.ts:517](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L517)*
...
*Defined in [src/apis/evm/api.ts:543](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L543)*
...
*Defined in [src/apis/evm/api.ts:798](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L798)*
...
*Defined in [src/apis/evm/api.ts:804](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L804)*
...
*Defined in [src/apis/evm/api.ts:141](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L141)*
...
*Defined in [src/apis/evm/api.ts:118](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L118)*
...
*Defined in [src/apis/evm/api.ts:225](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L225)*
...
*Defined in [src/apis/evm/api.ts:98](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/api.ts#L98)*
