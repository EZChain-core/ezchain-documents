[ezchain](../README.md) › [API-Metrics](../modules/api_metrics.md) › [MetricsAPI](api_metrics.metricsapi.md)

# Class: MetricsAPI

Class for interacting with a node API that is using the node's MetricsApi.

**`remarks`** This extends the [RESTAPI](common_restapi.restapi.md) class. This class should not be directly called. Instead, use the [EZChain.addAPI](ezchain.ezchain-1.md#addapi) function to register this interface with EZChain.
...
\+ **new MetricsAPI**(`core`: [EZChainCore](ezchaincore.ezchaincore-1.md), `baseURL`: string): *[MetricsAPI](api_metrics.metricsapi.md)*

*Overrides [RESTAPI](common_restapi.restapi.md).[constructor](common_restapi.restapi.md#constructor)*

*Defined in [src/apis/metrics/api.ts:32](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/metrics/api.ts#L32)*
...
*Defined in [src/common/restapi.ts:12](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/common/restapi.ts#L12)*
...
*Defined in [src/common/restapi.ts:11](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/common/restapi.ts#L11)*
...
*Defined in [src/apis/metrics/api.ts:18](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/metrics/api.ts#L18)*
...
*Defined in [src/common/restapi.ts:110](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/common/restapi.ts#L110)*
...
*Defined in [src/common/restapi.ts:40](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/common/restapi.ts#L40)*
...
*Defined in [src/common/restapi.ts:171](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/common/restapi.ts#L171)*
...
*Defined in [src/common/restapi.ts:166](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/common/restapi.ts#L166)*
...
*Defined in [src/apis/metrics/api.ts:29](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/metrics/api.ts#L29)*
...
*Defined in [src/common/restapi.ts:136](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/common/restapi.ts#L136)*
...
*Defined in [src/common/restapi.ts:56](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/common/restapi.ts#L56)*
...
*Defined in [src/common/restapi.ts:14](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/common/restapi.ts#L14)*
...
*Defined in [src/common/restapi.ts:83](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/common/restapi.ts#L83)*
