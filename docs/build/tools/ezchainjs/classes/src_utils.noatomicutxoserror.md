[ezchain](../README.md) › [src/utils](../modules/src_utils.md) › [NoAtomicUTXOsError](src_utils.noatomicutxoserror.md)
...
*Defined in [src/utils/errors.ts:81](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/utils/errors.ts#L81)*
