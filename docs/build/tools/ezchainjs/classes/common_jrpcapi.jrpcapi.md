[ezchain](../README.md) › [Common-JRPCAPI](../modules/common_jrpcapi.md) › [JRPCAPI](common_jrpcapi.jrpcapi.md)
...
\+ **new JRPCAPI**(`core`: [EZChainCore](ezchaincore.ezchaincore-1.md), `baseURL`: string, `jrpcVersion`: string): *[JRPCAPI](common_jrpcapi.jrpcapi.md)*
