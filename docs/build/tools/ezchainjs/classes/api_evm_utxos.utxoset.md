[ezchain](../README.md) › [API-EVM-UTXOs](../modules/api_evm_utxos.md) › [UTXOSet](api_evm_utxos.utxoset.md)
...
*Defined in [src/apis/evm/utxos.ts:127](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/utxos.ts#L127)*
...
*Defined in [src/apis/evm/utxos.ts:126](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/utxos.ts#L126)*
...
*Defined in [src/apis/evm/utxos.ts:203](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/utxos.ts#L203)*
...
▸ **buildExportTx**(`networkID`: number, `blockchainID`: Buffer, `amount`: BN, `ezcAssetID`: Buffer, `toAddresses`: Buffer[], `fromAddresses`: Buffer[], `changeAddresses`: Buffer[], `destinationChain`: Buffer, `fee`: BN, `feeAssetID`: Buffer, `asOf`: BN, `locktime`: BN, `threshold`: number): *[UnsignedTx](api_evm_transactions.unsignedtx.md)*

*Defined in [src/apis/evm/utxos.ts:443](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/utxos.ts#L443)*
...
`ezcAssetID` | Buffer | - | [Buffer](https://github.com/feross/buffer) of the AssetID for EZC |
...
*Defined in [src/apis/evm/utxos.ts:327](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/utxos.ts#L327)*
...
*Defined in [src/apis/evm/utxos.ts:196](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/utxos.ts#L196)*
...
*Defined in [src/apis/evm/utxos.ts:192](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/utxos.ts#L192)*
...
*Defined in [src/apis/evm/utxos.ts:131](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/utxos.ts#L131)*
...
▸ **getMinimumSpendable**(`aad`: [AssetAmountDestination](api_evm_utxos.assetamountdestination.md), `asOf`: BN, `locktime`: BN, `threshold`: number): *[Error](src_utils.ezchainerror.md#static-error)*

*Defined in [src/apis/evm/utxos.ts:212](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/utxos.ts#L212)*
...
*Defined in [src/apis/evm/utxos.ts:176](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/utxos.ts#L176)*
