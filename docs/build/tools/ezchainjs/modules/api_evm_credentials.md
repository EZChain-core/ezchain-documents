[ezchain](../README.md) › [API-EVM-Credentials](api_evm_credentials.md)
...
*Defined in [src/apis/evm/credentials.ts:17](https://github.com/EZChain-core/ezchainjs/blob/5511161/src/apis/evm/credentials.ts#L17)*
