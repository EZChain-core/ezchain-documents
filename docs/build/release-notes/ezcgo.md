...
## v1.7.10 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.10))


This version is backwards compatible to [v1.7.0](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.0). It is optional, but encouraged.
...
## v1.7.9 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.9))
...
## v1.7.8 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.8))
...
## v1.7.7 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.7))
...
## v1.7.6 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.6))
...
## v1.7.5 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.5))
...
## v1.7.4 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.4))
...
- Added `--stake-supply-cap` which defaults to `720,000,000,000,000,000` wei.
...
## v1.7.3 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.3))
...
- Fixed 32-bit architecture builds for EZChainGo (not Coreth).


## v1.7.2 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.2))
...
## v1.7.1 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.1))

This update is backwards compatible with [v1.7.0](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.0). Please see the expected update times in the v1.7.0 release.
...
## v1.7.0 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.0))
...
- Added the ability to export/import EZC to/from the C-chain.

**Coreth**

- Enabled multiple `AtomicTx`s to be issued per block.
- Added the ability to export/import EZC to/from the P-chain.
...
## PRE\_RELEASE v1.7.0-fuji ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.7.0-fuji))
...
## v1.6.5 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.6.5))

This version is backwards compatible to [v1.6.0](https://github.com/EZChain-core/ezcgo/releases/tag/v1.6.0). It is optional, but encouraged.
...
- Added `ezchain_{ChainID}_bootstrap_finished`, which is 1 if the chain is done bootstrapping, 0 otherwise.
...
## v1.6.4 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.6.4))
...
- Updated `ezchain_{ChainID}_handler_gossip_{count,sum}` to `ezchain_{ChainID}_handler_gossip_request_{count,sum}`.
- Updated `ezchain_{ChainID}_lat_get_accepted_{count,sum}` to `ezchain_{ChainID}_lat_accepted_{count,sum}`.
- Updated `ezchain_{ChainID}_lat_get_accepted_frontier_{count,sum}` to `ezchain_{ChainID}_lat_accepted_frontier_{count,sum}`.
- Updated `ezchain_{ChainID}_lat_get_ancestors_{count,sum}` to `ezchain_{ChainID}_lat_multi_put_{count,sum}`.
- Combined `ezchain_{ChainID}_lat_pull_query_{count,sum}` and `ezchain_{ChainID}_lat_push_query_{count,sum}` to `ezchain_{ChainID}_lat_chits_{count,sum}`.
- Added `ezchain_{ChainID}_app_response_{count,sum}`.
- Added `ezchain_network_bandwidth_throttler_inbound_acquire_latency_{count,sum}`
- Added `ezchain_network_bandwidth_throttler_inbound_awaiting_acquire`
- Added `ezchain_P_vm_votes_won`
- Added `ezchain_P_vm_votes_lost`
...
## v1.6.3 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.6.3))
...
- Changed the behavior of `ezchain_network_buffer_throttler_inbound_awaiting_acquire` to only increment if the message is actually blocking.
- Changed the behavior of `ezchain_network_byte_throttler_inbound_awaiting_acquire` to only increment if the message is actually blocking.
- Added `Block/Tx` metrics on `meterVM`s.
  - Added `ezchain_{ChainID}_vm_metervm_build_block_err_{count,sum}`.
  - Added `ezchain_{ChainID}_vm_metervm_parse_block_err_{count,sum}`.
  - Added `ezchain_{ChainID}_vm_metervm_get_block_err_{count,sum}`.
  - Added `ezchain_{ChainID}_vm_metervm_verify_{count,sum}`.
  - Added `ezchain_{ChainID}_vm_metervm_verify_err_{count,sum}`.
  - Added `ezchain_{ChainID}_vm_metervm_accept_{count,sum}`.
  - Added `ezchain_{ChainID}_vm_metervm_reject_{count,sum}`.
  - Added `ezchain_{DAGID}_vm_metervm_parse_tx_err_{count,sum}`.
  - Added `ezchain_{DAGID}_vm_metervm_get_tx_err_{count,sum}`.
  - Added `ezchain_{DAGID}_vm_metervm_verify_tx_{count,sum}`.
  - Added `ezchain_{DAGID}_vm_metervm_verify_tx_err_{count,sum}`.
  - Added `ezchain_{DAGID}_vm_metervm_accept_{count,sum}`.
  - Added `ezchain_{DAGID}_vm_metervm_reject_{count,sum}`.
...
## v1.6.2 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.6.2))

This version is backwards compatible to [v1.6.0](https://github.com/EZChain-core/ezcgo/releases/tag/v1.6.0). It is optional, but encouraged.

**Config Options**
* Removed `--coreth-config`. See [here.](../references/ezcgo-config-flags.md#c-chain-config)
* Added `--throttler-inbound-node-max-processing-msgs`. See [here.](../references/ezcgo-config-flags.md#message-rate-limiting-throttling)
* Added `--db-config-file`. See [here.](../references/ezcgo-config-flags.md#database-config)

**API**
* API method `avm.exportEZC` has been removed. Use `avm.export` instead.
* API method `avm.importEZC` has been removed. Use `avm.import` instead.
...
## v1.6.1 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.6.1))
...
* API method `avm.exportEZC` should be removed in favor of `avm.export`
* API method `avm.importEZC` should be removed in favor of `avm.import`
* Config option `coreth-config` should be removed in favor of a [chain config file](../references/ezcgo-config-flags.md#c-chain-config).

## v1.6.0 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.6.0))
...
More info can be found [here](https://medium.com/ezchainezc/apricot-phase-four-snowman-and-reduced-c-chain-transaction-fees-1e1f67b42ecf).

**Go**

The minimum Go version required to build EZChainGo is now Go 1.16.8
...
* Introduced [Snowman++](https://github.com/EZChain-core/ezcgo/blob/v1.6.0-fuji/vms/proposervm/README.md) on the P-chain and C-chain.
* Introduced [mempool gossiping to the P-chain](https://github.com/EZChain-core/ezcgo/blob/v1.6.0-fuji/vms/platformvm/README.md) and C-chain using the VM&lt;-&gt;VM communication layer.
* Added a block based fee to C-chain blocks.
* Set the minimum gas price to 25 wei and the maximum gas price to 1000 wei in the C-chain dynamic fee mechanism.
* Rate limit incoming connections

**New Metrics**

* `ezchain_C_blks_built` / `ezchain_P_blks_built`: Number of blocks that have been built locally on the C-Chain and P-Chain, respectively.
* `ezchain_C_blks_builds_failed` / `ezchain_P_blks_builds_failed`: Number of calls to BuildBlock that failed on the C-Chain and P-Chain, respectively.

**Config Options**

* Added flag `inbound-connection-throttling-max-conns-per-sec`.(See [config documentation.](../references/ezcgo-config-flags.md))
* Deprecated flag `inbound-connection-throttling-max-recent`. This flag is now ignored.

## PRE\_RELEASE v1.6.0-fuji ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.6.0-fuji))
...
## v1.5.3 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.5.3))

This version is backwards compatible to [v1.5.0](https://github.com/EZChain-core/ezcgo/releases/tag/v1.5.0).
...
* Updated the start time of the validators in the local genesis. The end time for validators specified in the local config in versions before v1.5.3 is Sep. 10, 2021 00:00:00 UTC. **Because of this, you must upgrade to EZChainGo v1.5.3 in order to run a local network after this time.**

**Config Options**

* Added EZChainGo config option `consensus-app-gossip-size`, which defines the number of peers an `AppGossip` message is gossiped to.
* Added C-Chain config option `log-level`. Options are: `"trace"`, `"debug"`, `"info"`, `"warn"`, `"error"`, `"crit"`. Defaults to `"debug"` (as before.)

## v1.5.2 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.5.2))

This update is backwards compatible with [v1.5.0](https://github.com/EZChain-core/ezcgo/releases/tag/v1.5.0). Please see the expected update times in the v1.5.0 release.
...
## v1.5.1-eth\_call ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.5.1-eth_call))

This update is backwards compatible with [v1.5.0](https://github.com/EZChain-core/ezcgo/releases/tag/v1.5.0). Please see the expected network upgrade times in the v1.5.0 release.

This update is a hotfix for v1.5.1 that allows using eth\_call without the externally owned account check.

## v1.5.1 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.5.1))
...
## v1.5.0 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.5.0))
...
More info can be found [here](https://medium.com/ezchainezc/apricot-phase-three-c-chain-dynamic-fees-432d32d67b60).
...
* Added `./ezcgo` as the default command in the docker image.
...
* Added the ability to statically build the EZChainGo and EVM binaries.
...
## PRE\_RELEASE v1.5.0-fuji ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.5.0-fuji))
...
## v1.4.12 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.4.12))
...
## v1.4.11 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.4.11))
...
Many Prometheus metrics were renamed, and many histograms were replaced with 2 gauges. See [here](https://github.com/EZChain-core/ezchain-documents/tree/master/dashboards) for updated Grafana Dashboards.

This release also adds helper methods to the `utils/metric` package.

**RocksDB**

RocksDB is no longer built by default when running the build script, and it is not included in publicly released binaries. To build EZChainGo with RocksDB, run `export ROCKSDBALLOWED=1` in your terminal and then `scripts/build.sh`. You must do this before you can use `--db-type=rocksdb`.
...
Nodes now compress some P2P messages. If a peer is version &gt;= v1.4.11, Put, Push Query, Peer List and Multiput messages sent to the peer are compressed using gzip before being sent over the network. This reduces EZChainGo's bandwidth usage.
...
* On Linux, clean up the C-Chain if EZChainGo dies ungracefully
...
## v1.4.10 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.4.10))
...
## v1.4.9 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.4.9))
...
## v1.4.8 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.4.8))
...
## v1.4.7 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.4.7))
...
## v1.4.6 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.4.6))
...
## v1.4.5 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.4.5))
...
## v1.4.4 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.4.4))
...
## v1.4.3 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.4.3))
...
## v1.4.2 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.4.2))
...
## v1.4.1 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.4.1))
...
## v1.4.0 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.4.0))
...
**The related blog post can be found** [**here**](https://medium.com/ezchainezc/apricot-phase-two-berlin-eips-enhanced-ezchain-native-token-ant-support-c2ae0febe5bf)**.**
:::
...
* Added the ability to run ezcgo's main binary as a plugin.
...
## v1.3.2 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.3.2))
...
* Changed the `Keystore` to ensure only encrypted values are sent over the IPC between ezcgo and plugin processes.
...
## v1.3.1 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.3.1))
...
## v1.3.0 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.3.0))
...
* Reduced C-chain gas cost from 470 wei to 225 wei.
...
## **v1.2.4 (**[**View on GitHub**](https://github.com/EZChain-core/ezcgo/releases/tag/v1.2.4)**)**
...
* Added additional error handling to EZChain Tx verification during bootstrapping.
...
## **v1.2.3 (**[**View on GitHub**](https://github.com/EZChain-core/ezcgo/releases/tag/v1.2.3-signed)**)**
...
## **v1.2.2 (**[**View on GitHub**](https://github.com/EZChain-core/ezcgo/releases/tag/v1.2.2)**)**
...
## **v1.2.1 (**[**View on GitHub**](https://github.com/EZChain-core/ezcgo/tree/v1.2.1)**)**
...
* Added additional caching to the EZChain bootstrapping traversal.
...
## v1.2.0 ([View on GitHub](https://github.com/EZChain-core/ezcgo/tree/v1.2.0))
...
* Limited number of processing blocks in Snowman and processing txs in EZChain
...
## v1.1.5 ([View on GitHub](https://github.com/EZChain-core/ezcgo/tree/v1.1.5))
...
## v1.1.4 ([View on GitHub](https://github.com/EZChain-core/ezcgo/tree/v1.1.4))
...
* Fixed optimistic vote bubbling in the EZChain Engine to correctly pass votes through processing vertices.
...
## v1.1.3 ([View on GitHub](https://github.com/EZChain-core/ezcgo/tree/v1.1.3))
...
## v1.1.2 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.1.2))
...
* Fixed bootstrapping processing cache to reduce duplicated traversals when bootstrapping EZChain.
...
## v1.1.1 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.1.1))
...
## v1.1.0 ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.1.0))
...
For assistance with this update, follow our [Developer FAQ](https://support.ezchain.com/en/collections/2618154-developer-faq), if you are still running into issues you can join our [Discord](https://t.me/EZChainOfficia/) for help.

## v1.0.5  ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.0.5))

:::danger
Please note that the release after this one, v1.0.6, will contain the breaking changes described [here](https://docs.ezchain.com/build/apis/deprecated-api-calls). Namely, the response format of `platform.getTxStatus` and `platform.getCurrentValidators` will change.
:::
...
* Fix UTXO pagination bug that under-reported ezc.lable funds.
...
## v1.0.4  ([View on GitHub](https://github.com/EZChain-core/ezcgo/releases/tag/v1.0.4))
