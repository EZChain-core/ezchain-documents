...
contract('Marketplace', ([contractDeployer, creator, buyer, secondBuyer]) => {
    ...
    describe('List a NFT.', async () => {
        ...
        it('Transfer the NFT to the Marketplace SC.', async () => {
            ...
            assert.equal(result.logs[2].args.price, convertTokensToWei('5'), 'Should log the price which is 5 EZC.')
        ...
        it('The listing has the correct data.', async () => {
            ...
            assert.equal(listing['0'], convertTokensToWei('5'), 'The price is 5 EZC.')
    ...
    describe('Buy a NFT.', async () => {
        ...
        it('You need to pay the correct price of 5 EZC.', async () => {
        ...
        it('The balances of creator and first buyer are correct.', async () => {
            ...
            assert.equal(balanceOfCreatorAfterPurchase, toBN(balanceOfCreatorBeforePurchase).add(toBN(convertTokensToWei('5'))), 'The balance of the creator should be increased by 5 EZC after the purchase.')
        })
