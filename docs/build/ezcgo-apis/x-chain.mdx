---
description: The X-Chain is an instance of the EZChain Virtual Machine (AVM)
sidebar_position: 5
---
...
The [X-Chain](../../learn/platform-overview/README.md#exchange-chain-x-chain), EZChain’s native platform for creating and trading assets, is an instance of the EZChain Virtual Machine (AVM). This API allows clients to create and trade assets on the X-Chain and other instances of the AVM.
            ...
            "asset1": {
                ...
                "initialState": {
                    "fixedCap" : [
                        {
                            "amount":100000,
                            "address": "ezc13ery2kvdrkd2nkquvs892gl8hg7mq4a6ufnrn6"
                        },
                        {
                            "amount":100000,
                            "address": "ezc1rvks3vpe4cm9yc0rrk8d5855nd6yxxutfc2h2r"
                        },
                        {
                            "amount":50000,
                            "address": "ezc1ntj922dj4crc4pre4e0xt3dyj0t5rsw9uw0tus"
                        },
                        {
                            "amount":50000,
                            "address": "ezc1yk0xzmqyyaxn26sqceuky2tc2fh2q327vcwvda"
                        }
                    ]
                }
            },
            "asset2": {
                ...
                "initialState": {
                    "variableCap" : [
                        {
                            "minters": [
                                "ezc1kcfg6avc94ct3qh2mtdg47thsk8nrflnrgwjqr",
                                "ezc14e2s22wxvf3c7309txxpqs0qe9tjwwtk0dme8e"
                            ],
                            "threshold":1
                        },
                        {
                            "minters": [
                                "ezc1y8pveyn82gjyqr7kqzp72pqym6xlch9gt5grck",
                                "ezc1c5cmm0gem70rd8dcnpel63apzfnfxye9kd4wwe",
                                "ezc12euam2lwtwa8apvfdl700ckhg86euag2hlhmyw"
                            ],
                            "threshold":2
                        }
                    ]
...
```json
{
    "jsonrpc": "2.0",
    "result": {
        "address": "X-ezc12c6n252g5v3w6a6v69f0mnnzwr77jxzr3q3u7d"
    },
    "id": 1
}
```
...
curl -X POST --data '{
    ...
    "params" :{
        ...
        "initialHolders": [
            {
                "address": "X-ezc1s65kep4smpr9cnf6uh9cuuud4ndm2z4jguj3gp",
                "amount": 10000
            },
            {
                "address":"X-ezc1y0h66sjk0rlnh9kppnfskwpw2tpcluzxh9png8",
                "amount":50000
            }
        ],
...
curl -X POST --data '{
    ...
    "params" :{
        ...
        "to":"X-ezc1ap39w4a7fk0au083rrmnhc2pqk20yjt6s3gzkx",
        "from":["X-ezc1s65kep4smpr9cnf6uh9cuuud4ndm2z4jguj3gp"],
        "changeAddr":"X-ezc1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8",
        "username":"myUsername",
        "password":"myPassword"
...
curl -X POST --data '{
    ...
    "params" :{
        ...
        "minterSets":[
            {
                "minters":[
                    "X-ezc14q0p6y4yzweuugz9p080kapajwvac3ur755n7d"
                ],
                "threshold": 1
            },
            {
                "minters": [
                    "X-ezc1fzyldr3mwn6lj7y46edhua6vr5ayx0ruuhezpv",
                    "X-ezc1x5mrgxj0emysnnzyszamqxhq95t2kwcp9n3fy3",
                    "X-ezc13zmrjvj75h3578rn3sfth8p64t2ll4gm4tv2rp"
                ],
                "threshold": 2
            }
        ],
...
curl -X POST --data '{
    ...
    "params" :{
        ...
        "minterSets":[
            {
                "minters":[
                    "X-ezc1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8"
                ],
                "threshold": 1
            }
        ],
        "from": ["X-ezc1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8"],
        "changeAddr": "X-ezc1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8",
        "username":"myUsername",
        "password":"myPassword"
    }
...
you must call the [C-Chain's `ezc.import`](c-chain.md#ezcimport) or the 
[P-Chain's `platform.importEZC`](p-chain.md#platformimportezc) to complete the transfer.
...
* `assetID` is the asset id of the asset which is sent. Use `EZC` for EZC exports.
* `from` are the addresses that you want to use for this operation. If omitted, uses any of your addresses as needed.
* `changeAddr` is the address any change will be sent to. If omitted, change is sent to one of the addresses controlled by the user.
...
curl -X POST --data '{
    ...
    "method" :"avm.export",
    "params" :{
        "to":"C-ezc1q9c6ltuxpsqz7ul8j0h0d0ha439qt70sr3x2m0",
        "amount": 10,
        "assetID": "EZC",
        "from":["X-ezc1s65kep4smpr9cnf6uh9cuuud4ndm2z4jguj3gp"],
        "changeAddr":"X-ezc1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8",
...
curl -X POST --data '{
    ...
    "params" :{
        "address":"X-ezc1c79e0dd0susp7dc8udq34jgk2yvve7hapvdyht"
    }
}' -H 'content-type:application/json;' 127.0.0.1:9650/ext/bc/X
```
...
curl -X POST --data '{
  ...
  "params" :{
      "address":"X-ezc1ns3jzhqyk7parg29qan56k0fcxwstc76cjqq2s",
                ...
                "outputs": [
                    {
                        ...
                        "output": {
                            "addresses": [
                                "X-ezc126rd3w35xwkmj8670zvf7y5r8k36qa9z9803wm"
                            ],
                            "amount": 1530084210,
                            "locktime": 0,
                            "threshold": 1
...
* `networkID` is the ID of the network this transaction happened on. (EZChain Mainnet is `1`.)
* `blockchainID` is the ID of the blockchain this transaction happened on. (EZChain Mainnet X-Chain is `2oYMBNV4eNHyqk2fjjV5nVQLDbtmNJzq5s3qs3Lo6ftnC6FByM`.)
...
* `assetID`: The ID of the asset being transferred. (The Mainnet EZCx ID is `FvwEAhmxKfeiG8SnEvq42hc6whRyY3EFYAvebMqDNDGCgxN5Z`.)
...
Suppose we want all UTXOs that reference at least one of `X-ezc1yzt57wd8me6xmy3t42lz8m5lg6yruy79m6whsf` and `X-ezc1x459sj0ssujguq723cljfty4jlae28evjzt7xz`.
...
curl -X POST --data '{
    ...
    "method" :"avm.getUTXOs",
    "params" :{
        "addresses":["X-ezc1yzt57wd8me6xmy3t42lz8m5lg6yruy79m6whsf", "X-ezc1x459sj0ssujguq723cljfty4jlae28evjzt7xz"],
        "limit":5,
        "encoding": "cb58"
    }
}' -H 'content-type:application/json;' 127.0.0.1:9650/ext/bc/X
...
```json
{
    ...
    "result": {
        ...
        "endIndex": {
            "address": "X-ezc1x459sj0ssujguq723cljfty4jlae28evjzt7xz",
...
curl -X POST --data '{
    ...
    "method" :"avm.getUTXOs",
    "params" :{
        "addresses":["X-ezc1x459sj0ssujguq723cljfty4jlae28evjzt7xz"],
        "limit":5,
        "endIndex": {
            "address": "X-ezc1x459sj0ssujguq723cljfty4jlae28evjzt7xz",
            "utxo": "kbUThAUfmBXUmRgTpgD6r3nLj7rJUGho6xyht5nouNNypH45j"
...
Finalize a transfer of an asset from the P-Chain or C-Chain to the X-Chain. Before this method is called, you must call the P-Chain’s [`platform.exportEZC`](p-chain.md#platformexportezc) or C-Chain’s [`ezc.export`](c-chain.md#ezcexport) method to initiate the transfer.
...
* `to` is the address the EZC is sent to. This must be the same as the `to` argument in the corresponding call to the P-Chain’s `exportEZC` or C-Chain's `export`.
* `sourceChain` is the ID or alias of the chain the EZC is being imported from. To import funds from the C-Chain, use `"C"`.
...
curl -X POST --data '{
    ...
    "method" :"avm.import",
    "params" :{
        "to":"X-ezc1s7aygrkrtxflmrlyadlhqu70a6f4a4n8l2tru8",
        "sourceChain":"C",
        "username":"myUsername",
        "password":"myPassword"
    }
...
```json
{
    ...
    "id"     :1,
    "result" :{
        "address":"X-ezc1mwlnrzv0ezdycx4qhqj77j55cwgcvtf29zvmpy"
    }
}
```
...
```json
{
    "jsonrpc": "2.0",
    "result": {
        "addresses": ["X-ezc1rt4vac58crp0p59yf640c4gycm6creg2rt8hc6"]
    },
    "id": 1
}
```
...
* Sends `amount` units of asset with ID `assetID` to address `to`. `amount` is denominated in the smallest increment of the asset. For EZC this is 1 wei (one billionth of 1 EZC.)
...
curl -X POST --data '{
    ...
    "params" :{
        "assetID"   : "EZC",
        "amount"    : 10000,
        "to"        : "X-ezc1yzt57wd8me6xmy3t42lz8m5lg6yruy79m6whsf",
        "from"      : ["X-ezc1s65kep4smpr9cnf6uh9cuuud4ndm2z4jguj3gp"],
        "changeAddr": "X-ezc1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8",
        "memo"      : "hi, mom!",
    ...
    "params" :{
        "outputs": [
            ...
            },
            {
                ...
                "to"      : "X-ezc18knvhxx8uhc0mwlgrfyzjcm2wrd6e60w37xrjq",
                "amount"  : 10
            }
        ],
        "memo"      : "hi, mom!",
...
import (
    ...
    "github.com/EZChain-core/ezcgo/pubsub"
