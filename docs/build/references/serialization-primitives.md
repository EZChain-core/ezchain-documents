...
[EZChain](../../#ezchain) uses a simple, uniform, and elegant representation for all internal data. This document describes how primitive types are encoded on the EZChain platform. Transactions are encoded in terms of these basic primitive types.
